...
namespace ClientLibrary.Services.Implementations
{
    public class UserAccountService(GetHttpClient getHttpClient) : IUserAccountService
    {
        ...
        public async Task<LoginResponse?> RefreshTokenAsync(RefreshToken token)
        {
            ...
            if (!result.IsSuccessStatusCode) return new LoginResponse(false, "Failed to refresh token");
        ...
        public async Task<GeneralResponse?> UpdateUser(ManageUser user)
        {
            ...
            if (!result.IsSuccessStatusCode) return new GeneralResponse(false, "Failed to update user");
        ...
        public async Task<GeneralResponse?> DeleteUser(int id)
        {
            ...
            if (!result.IsSuccessStatusCode) return new GeneralResponse(false, "Failed to delete user");
